...
var replaceDirsSeparator = function(navFiles) {
    // Path is used as key in navFiles, some paths have \\ as separator between folders
    for (var oldKey in navFiles) {
        // Replace \\ separator by /
        var newKey = oldKey.replace(/\\/g, "/");
        if (oldKey !== newKey) {
            Object.defineProperty(navFiles, newKey,
                Object.getOwnPropertyDescriptor(navFiles, oldKey));
